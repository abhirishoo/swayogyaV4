...
const Swaknee = () => {
  return (
    ...
    <hr className='  border-[1.5px] bg-black' />
        
      <div className='mb-1 md:mb-5 ml-8 md:ml-[12%] lg:mt-[80%] mt-10 md:mt-16 font-bold text-[#C2185B] text-3xl lg:text-5xl tracking-tight'>
        Swaknee
      </div>
      <div className='grid grid-cols-1 md:grid-cols-2 w-[90%] md:w-[80%]  md:ml-[11%] ml-5 h-[50%] md:h-[53.6vh] shadow-lg'>
        <div className=' '>
        ...
        <div className='flex flex-col  px-4 md:px-8 py-4 md:py-7'>
          ...
          <div className=' flex px-5 md:ml-[75%] md:mt-[5%]  font-bold text-[#0288D1] text-[0.1vw] lg:text-[1vw] 
            tracking-tight cursor-pointer hover:text-[#00b0ff] hover:translate-x-1 transition duration-300 ease-in-out  '><Link to={"/product"} > Swaknee </Link>
            </div>

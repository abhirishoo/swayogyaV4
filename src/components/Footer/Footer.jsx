...
export default function FooterAdvancedExample() {
    return (
        <footer className="bg-[#02569C] text-center text-white">
            <div className=" px-6 pt-6 mx-auto">
                        ...
                        <div
                            ...
                            {/* <div className="relative md:mb-6">
                              <TEInput
                                theme={{
                                  label:
                                    "pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate text-white transition-all duration-200 ease-out peer-focus:scale-[0.8] peer-focus:text-white motion-reduce:transition-none  peer-focus:text-white",
                                }}
                ...
                <div className="grid md:grid-cols-2 md:text-start md:ml-20 lg:grid-cols-4">
                    ...
                    <div className="mb-6">
                        ...
                        <ul className="mb-0 list-none ">
                            <li>
                                <a className="text-white">PEMF Therapy Devices</a>
                            </li>
                            <li>
                                <a className="text-white">Rehabilitation Services</a>
                            </li>
                            <li>
            ...
            {/* <!-- Copyright section --> */}
            <div
                className="p-4 text-center  bg-[#263238]">
                © 2023 Copyright |  
                <a className="text-white ml-1" href="https://tw-elements.com/"
                > Swayogya</a>
            </div>
        </footer>
    );
